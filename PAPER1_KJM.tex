...
\usepackage{mathrsfs}
\setlength{\textwidth}{5.0in} \setlength{\textheight}{7.3in}
\voffset -0.1 true cm \setlength{\headsep}{0.3in}
\setlength{\evensidemargin}{0.5in}
\font\headd=cmr8
\font\Bbb=msbm10 \pagestyle{myheadings}
\markboth
{ Authors }
{ title }
\begin{document}
...
\thispagestyle{plain}     
\markboth{}{}
\noindent{\large\bf Solution of Generalized Fractional Kinetic Equation Pertaining to Error Functions }
\footnote{{}\\ \\[-0.7cm]
...
\vspace{0.15in}
\noindent{\sc Ravi Kumar Jain and Alok Bhargava$^*$}
\newline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=75mm]{graph2_2.jpg}
    \caption{Solution of fractional Kinetic equation (2.2)}
\begin{figure}[H]
    \centering
    \includegraphics[width=75mm]{graph2_4.jpg}
